    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-12">
        ...
        >
          ...
          <div className="bg-card border-4 border-ink p-8 shadow-brutal relative">
            <p className="font-sans text-base text-ink font-medium leading-relaxed mb-6">
              I'm Abdulrafiu Ibrahim (Ari) — a Software Engineer and Tech
              Creative based in Nigeria. I build full-stack web applications for
              African startups and Web3 projects, and I document the entire
              journey for a growing audience of builders and founders.
            </p>

            <p className="font-sans text-base text-ink font-medium leading-relaxed mb-6">
              I work with clients in bringing their ideas to life. I build
              products, write threads, make videos, and reach out to the right
              people every week.
            </p>

            <p className="font-sans text-base text-ink font-medium leading-relaxed">
              I'm currently the technical lead on two products:{" "}
              <span className="font-bold underline decoration-2 underline-offset-2">
                Naija Trade Hub
              </span>{" "}
              — a marketplace connecting African homeowners with verified
              handymen — and{" "}
              <span className="font-bold underline decoration-2 underline-offset-2">
                TipMe
              </span>
              , a tipping platform for Nigerian creatives. Both are in active
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-accent-light border-4 border-ink shadow-brutal p-6 hover:-translate-y-1 hover:translate-x-1 hover:shadow-brutal-sm transition-all">
            ...
            <div className="font-sans font-bold uppercase tracking-wide text-xs text-ink md:text-sm pt-2 border-t-2 border-ink">
      ...
      <div className="mt-24 border-4 border-ink bg-card p-8 md:p-12 shadow-brutal relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {/* Languages */}
          <div>
            <h3 className="font-sans font-black text-xl text-ink mb-6 uppercase tracking-tight border-b-4 border-ink inline-block">
              Languages
            </h3>
            <div className="flex flex-wrap gap-2">
              {["Python", "JavaScript", "C#", "TypeScript", "SQL"].map(
                (tech) => (
                  <span
                    key={tech}
                    className="bg-accent-light px-3 py-1 border-2 border-ink font-bold text-sm shadow-brutal-sm"
                  >
                    {tech}
                  </span>
                ),
